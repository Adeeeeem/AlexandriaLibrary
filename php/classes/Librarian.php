<?php
	...
	class Librarian
	{
		...
		{
			/* Preparing Request */
			$request = "SELECT LIBRARIAN_ID AS ID, LIBRARIAN_LOGIN AS LOGIN, LIBRARIAN_PASSWORD AS PASSWORD, LIBRARIAN_FNAME AS FNAME, LIBRARIAN_LNAME AS LNAME, LIBRARIAN_EMAIL AS EMAIL FROM ".$this->TABLE_NAME." ORDER BY LIBRARIAN_FNAME, LIBRARIAN_LNAME, LIBRARIAN_LOGIN;";
			/* Preparing Statement */
			$statement = $this->CONNECTION->prepare($request);
			/* Execute Query */
			if ($statement->execute())
